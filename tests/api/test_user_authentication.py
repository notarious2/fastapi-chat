...
async def test_bob_user_login_succeeds_given_valid_credentials(async_client: AsyncClient, bob_user: User):
    url = "/login/"
...
async def test_bob_user_login_fails_given_invalid_username(async_client: AsyncClient):
    url = "/login/"
...
async def test_bob_user_login_fails_given_invalid_password(async_client: AsyncClient, bob_user: User):
    url = "/login/"
